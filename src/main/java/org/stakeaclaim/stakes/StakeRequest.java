...
//import org.stakeaclaim.stakes.UnsupportedIntersectionException;
 ...
 * @author sk89q
 */
public abstract class StakeRequest implements Comparable<StakeRequest> {
...
//     */
//    public void setParent(StakeRequest parent) throws CircularInheritanceException {
//        if (parent == null) {
//            this.parent = null;
//            return;
//        }
...
//        }
//
//        StakeRequest p = parent.getParent();
//        while (p != null) {
//            if (p == this) {
//                throw new CircularInheritanceException();
//            }
...
//        }
//
//        StakeRequest curParent = getParent();
...
//     */
//    public abstract List<StakeRequest> getIntersectingRequests(
//            List<StakeRequest> requests)
...
//     */
//    protected boolean intersectsBoundingBox(StakeRequest request) {
...
//     */
//    protected boolean intersectsEdges(StakeRequest request) {
...
//        if (!(obj instanceof StakeRequest)) {
//            return false;
//        }
//
//        StakeRequest other = (StakeRequest) obj;
