...
public class ApplicableRequestSet implements Iterable<StakeRequest> {
    ...
    private StakeRequest globalRequest;
...
//     */
//    public StakeRequest getClaim() {
//        StakeRequest claim = null;
//        StakeRequest parent = null;
//        for (StakeRequest request : this) {
...
//     */
//    private void clearParents(Set<StakeRequest> needsClear,
//            Set<StakeRequest> hasCleared, StakeRequest request) {
...
//        boolean found = false;
//
//        Map<StakeRequest, V> needsClear = new HashMap<StakeRequest, V>();
//        Set<StakeRequest> hasCleared = new HashSet<StakeRequest>();
//
//        for (StakeRequest request : applicable) {
//            // Ignore lower priority requests
...
//     * @param request The request to start from
//     */
//    private void clearParents(Map<StakeRequest, ?> needsClear,
//            Set<StakeRequest> hasCleared, StakeRequest request) {
//        StakeRequest parent = request.getParent();
//
//        while (parent != null) {
