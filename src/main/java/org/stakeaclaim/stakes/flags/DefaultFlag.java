...
package org.stakeaclaim.stakes.flags;
...
public final class DefaultFlag {
    ...
    public static final StateFlag PASSTHROUGH = new StateFlag("passthrough", false, RequestGroup.ALL);
    public static final StateFlag BUILD = new StateFlag("build", true, RequestGroup.NON_MEMBERS);
    public static final RequestGroupFlag CONSTRUCT = new RequestGroupFlag("construct", RequestGroup.MEMBERS);
    public static final StateFlag PVP = new StateFlag("pvp", true, RequestGroup.ALL);
    public static final StateFlag MOB_DAMAGE = new StateFlag("mob-damage", true, RequestGroup.ALL);
    public static final StateFlag MOB_SPAWNING = new StateFlag("mob-spawning", true, RequestGroup.ALL);
    public static final StateFlag CREEPER_EXPLOSION = new StateFlag("creeper-explosion", true, RequestGroup.ALL);
    public static final StateFlag ENDERDRAGON_BLOCK_DAMAGE = new StateFlag("enderdragon-block-damage", true);
    public static final StateFlag GHAST_FIREBALL = new StateFlag("ghast-fireball", true, RequestGroup.ALL);
    ...
    public static final StateFlag TNT = new StateFlag("tnt", true, RequestGroup.ALL);
    public static final StateFlag LIGHTER = new StateFlag("lighter", true, RequestGroup.MEMBERS);
    ...
    public static final StateFlag INVINCIBILITY = new StateFlag("invincible", false, RequestGroup.ALL);
    public static final StateFlag EXP_DROPS = new StateFlag("exp-drops", true, RequestGroup.ALL);
    ...
    public static final StringFlag GREET_MESSAGE = new StringFlag("greeting", RequestGroup.ALL);
    public static final StringFlag FAREWELL_MESSAGE = new StringFlag("farewell", RequestGroup.ALL);
    public static final BooleanFlag NOTIFY_ENTER = new BooleanFlag("notify-enter", RequestGroup.ALL);
    public static final BooleanFlag NOTIFY_LEAVE = new BooleanFlag("notify-leave", RequestGroup.ALL);
    public static final SetFlag<EntityType> DENY_SPAWN = new SetFlag<EntityType>("deny-spawn", RequestGroup.ALL, new EntityTypeFlag(null));
    public static final EnumFlag<GameMode> GAME_MODE = new EnumFlag<GameMode>("game-mode", GameMode.class, RequestGroup.ALL);
    public static final IntegerFlag HEAL_DELAY = new IntegerFlag("heal-delay", RequestGroup.ALL);
    public static final IntegerFlag HEAL_AMOUNT = new IntegerFlag("heal-amount", RequestGroup.ALL);
    public static final IntegerFlag MIN_HEAL = new IntegerFlag("heal-min-health", RequestGroup.ALL);
    public static final IntegerFlag MAX_HEAL = new IntegerFlag("heal-max-health", RequestGroup.ALL);
    public static final IntegerFlag FEED_DELAY = new IntegerFlag("feed-delay", RequestGroup.ALL);
    public static final IntegerFlag FEED_AMOUNT = new IntegerFlag("feed-amount", RequestGroup.ALL);
    public static final IntegerFlag MIN_FOOD = new IntegerFlag("feed-min-hunger", RequestGroup.ALL);
    public static final IntegerFlag MAX_FOOD = new IntegerFlag("feed-max-hunger", RequestGroup.ALL);
    // public static final IntegerFlag MAX_PLAYERS = new IntegerFlag("max-players-allowed", RequestGroup.ALL);
    // public static final StringFlag MAX_PLAYERS_MESSAGE = new StringFlag("max-players-reject-message", RequestGroup.ALL);
    public static final LocationFlag TELE_LOC = new LocationFlag("teleport", RequestGroup.MEMBERS);
    public static final LocationFlag SPAWN_LOC = new LocationFlag("spawn", RequestGroup.MEMBERS);
    ...
    //public static final BooleanFlag CLAIM = new BooleanFlag("claim"); /* MCA add */
    public static final DoubleFlag PRICE = new DoubleFlag("price");
    public static final SetFlag<String> BLOCKED_CMDS = new SetFlag<String>("blocked-cmds", RequestGroup.ALL, new CommandStringFlag(null));
    public static final SetFlag<String> ALLOWED_CMDS = new SetFlag<String>("allowed-cmds", RequestGroup.ALL, new CommandStringFlag(null));
