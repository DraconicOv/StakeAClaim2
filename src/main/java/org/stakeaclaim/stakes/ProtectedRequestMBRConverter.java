...
public class ProtectedRequestMBRConverter implements MBRConverter<StakeRequest> {
    ...
    @Override
    public double getMax(int dimension, StakeRequest request) {
        switch (dimension) {
            case 0:
    ...
    @Override
    public double getMin(int dimension, StakeRequest request) {
        switch (dimension) {
            case 0:
