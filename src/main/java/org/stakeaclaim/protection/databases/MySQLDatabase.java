...
public class MySQLDatabase extends AbstractProtectionDatabase {
    ...
    private Map<String, Request> cuboidRequests;
    private Map<String, Request> poly2dRequests;
    private Map<String, Request> globalRequests;
    private Map<Request, String> parentSets;
...
//    }
//
//    private void loadFlags(Request request) {
//        // @TODO: Iterate _ONCE_
//        try {
...
//    }
//
//    private void loadOwnersAndMembers(Request request) {
...
//                Request request = new GlobalRequest(globalResultSet.getString("id"));
//
...
//                Request request = new ProtectedCuboidRequest(
...
//                    ));
//                }
//                Request request = new ProtectedPolygonalRequest(id, points, minY, maxY);
//
...
//        }
//
//        parentSets = new HashMap<Request,String>();
//
...
//        this.loadCuboid();
//        Map<String,Request> requests = this.cuboidRequests;
...
//    private void updateFlags(Request request) throws SQLException {
...
//    }
//
//    private void updatePlayerAndGroups(Request request, Boolean owners) throws SQLException {
...
//    }
//
//    private void insertRequest(Request request, String type) throws SQLException {
...
//    }
//
//    private void updateRequest(Request request, String type) throws SQLException  {
